...
public static unsafe partial class LibC
{
  ...
  [DllImport (libc, SetLastError = true)]
  public static extern int open (byte* pathname, int flags, mode_t mode = default);

  [DllImport (libc, SetLastError = true)]
  public static extern int openat (int dirfd, byte* pathname, int flags, mode_t mode = default);
