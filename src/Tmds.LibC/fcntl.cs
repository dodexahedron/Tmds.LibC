...
public static unsafe partial class LibC
{
  ...
  public const int FALLOC_FL_KEEP_SIZE  = 1;
  public const int FALLOC_FL_PUNCH_HOLE = 2;

  public const  int FAPPEND                     = O_APPEND;
  public const  int FASYNC                      = O_ASYNC;
  public const  int FFSYNC                      = O_SYNC;
  public const  int FNDELAY                     = O_NDELAY;
  public const  int FNONBLOCK                   = O_NONBLOCK;
  public const  int MAX_HANDLE_SZ               = 128;
  public const  int SPLICE_F_GIFT               = 8;
  public const  int SPLICE_F_MORE               = 4;
  public const  int SPLICE_F_MOVE               = 1;
  public const  int SPLICE_F_NONBLOCK           = 2;
  ...
  public static int openat2 (int dirfd, byte* pathname, open_how* how, size_t size) => (int)syscall (__NR_openat2, dirfd, pathname, how, size);
